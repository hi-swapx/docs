...
Consider checking out the [Concepts section](../../../../concepts/protocol/concentrated-liquidity.md) as well as the [SwapX Book](https://SwapXv3book.com/docs/introduction/SwapX-v3/).
