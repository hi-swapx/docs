...
Anvil by foundry is a newcomer that's fast and easy to setup.
...
You can also continue tapping into other developer tools that make smart contract development easier like forge from foundry.
To read more about foundry and their developer tooling, visit their GitHub or the [foundry book](https://book.getfoundry.sh/).
