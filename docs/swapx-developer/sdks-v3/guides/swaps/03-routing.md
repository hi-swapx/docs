...
We can get the **V3_SWAP_ROUTER_ADDRESS** for our chain from the `SwapRouter02` field in Deployments. 
...
Now that you're familiar with trading, consider checking out our next guides on pooling liquidity to SwapX!
