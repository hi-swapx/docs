...
It is based on the minting a position code example, found in the SwapX code examples repository.
To run this example, check out the examples's README and follow the setup instructions.
...
```typescript
import { computePoolAddress, FeeAmount } from '@swapx-lib/v3-sdk'
...
```typescript
import { Position } from '@swapx-lib/v3-sdk'
import { BigIntish } from '@swapx-lib/sdk-core'
...
```typescript
import { MintOptions, NonfungiblePositionManager } from '@swapx-lib/v3-sdk'
