...
The concepts and code snippets showcased here can be found across the **Pooling Liquidity** examples in the SwapX code examples repository.
...
- [`@swapx-lib/v3-periphery`](https://www.npmjs.com/package/@swapx-lib/v3-periphery)
...
Consider checking out the Concepts section as well as the [SwapX Book](https://swapxv3book.com/docs/introduction/swapx-v3/).
...
Take a look at the Mint Position guide and Modify Position guide to learn more.
