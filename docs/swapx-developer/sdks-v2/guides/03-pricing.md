...
```typescript
import { ChainId, Token, WETH9 } from '@swapx-lib/sdk-core'
import { Route } from '@swapx-lib/v2-sdk'
...
```typescript
import { ChainId, Token, WETH9} from '@swapx-lib/sdk-core'
import { Route, Pair } from '@swapx-lib/v2-sdk'
...
```typescript
import { ChainId, Token, WETH9, CurrencyAmount, TradeType } from '@swapx-lib/sdk-core'
import { Route, Pair, Trade } from '@swapx-lib/v2-sdk'
