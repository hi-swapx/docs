Below is the technical reference for the staker contract, `SwapXV3Staker.sol`. A technical guide for interacting with this staking contract will be released soon.
...
```solidity
  function constructor(
    contract ISwapXV3Factory _factory,
...
| Name                          | Type                                 | Description                                                                  |
| :---------------------------- | :----------------------------------- | :--------------------------------------------------------------------------- |
| `_factory`                    | contract ISwapXV3Factory           | the SwapX V3 factory                                                       |
...
```solidity
  function createIncentive(
    struct ISwapXV3Staker.IncentiveKey key,
    uint256 reward
  ) external
```
...
| Name     | Type                                 | Description                                   |
| :------- | :----------------------------------- | :-------------------------------------------- |
| `key`    | struct ISwapXV3Staker.IncentiveKey | Details of the incentive to create            |
...
| Name  | Type                                 | Description                     |
| :---- | :----------------------------------- | :------------------------------ |
| `key` | struct ISwapXV3Staker.IncentiveKey | Details of the incentive to end |
...
Upon receiving a SwapX V3 ERC721, creates the token deposit setting owner to `from`. Also stakes token
...
Withdraws a SwapX V3 LP token `tokenId` from this contract to the recipient `to`
...
Stakes a SwapX V3 LP token

#### Parameters:

| Name      | Type                                 | Description                                         |
| :-------- | :----------------------------------- | :-------------------------------------------------- |
| `key`     | struct ISwapXV3Staker.IncentiveKey | The key of the incentive for which to stake the NFT |
...
Unstakes a SwapX V3 LP token

#### Parameters:

| Name      | Type                                 | Description                                           |
| :-------- | :----------------------------------- | :---------------------------------------------------- |
| `key`     | struct ISwapXV3Staker.IncentiveKey | The key of the incentive for which to unstake the NFT |
...
| Name      | Type                                 | Description              |
| :-------- | :----------------------------------- | :----------------------- |
| `key`     | struct ISwapXV3Staker.IncentiveKey | The key of the incentive |
