...
```solidity
  function factory(
  ) external view returns (contract ISwapXV3Factory)
```

The SwapX V3 Factory
...
| :------------ | :---------------------- | :------------------------------------------------------------------------ |
| `rewardToken` | contract IERC20Minimal  | The token being distributed as a reward                                   |
| `pool`        | contract ISwapXV3Pool | The SwapX V3 pool                                                       |
...
Event emitted when a SwapX V3 LP token has been staked
...
Event emitted when a SwapX V3 LP token has been unstaked
