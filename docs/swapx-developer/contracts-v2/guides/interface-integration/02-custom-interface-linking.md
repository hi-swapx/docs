...
The SwapX front-end supports URL query parameters to allow for custom linking to the SwapX frontend. Users and developers can use these query parameters to link to the SwapX frontend with custom prefilled settings.
