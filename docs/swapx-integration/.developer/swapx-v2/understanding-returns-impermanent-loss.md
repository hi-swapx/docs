...
2. New Pool State: The new pool figures will be approximately 122,400 DAI and 817 WETH.
   * _Check:_ $`$1$ (our constant product) and $$1$ (our new price).
3. LP Withdrawal: The LP's 10% share now yields 12,240 DAI and 81.7 WETH.
   * Total Market Value: $$ ``$\approx \$``24,500$ $$.
4. HODL Value: If the LP had simply held their initial $$1$ DAI and $$1$ WETH, the total value would be: $$ ``$10,000 + (100 \times \$``150) = \$25,000$ $$.
...
1. New Pool Reserves (using formulas):
   * `$$`1$ (XOC)
   * $$1$ (DAI)
2. LP's New Share (1%): $$1$ XOC and $$1$ DAI.
3. Current Value of LP Share (converted to DAI): $$1$ DAI.
4. HODL Value: The initial $$1$ XOC and $$1$ DAI is now worth $$1$ DAI.
5. Impermanent Loss: The LP lost $$1$ DAI by providing liquidity instead of HODLing.
