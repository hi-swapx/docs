...
* If a provider is seeding a new pool, the amount of LP tokens they receive will be equal to $$1$, where $$1$ and $$1`$ represent the amounts of each token provided.
