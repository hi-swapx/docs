...
The governing rule is the constant product formula ($$1$). When either token is withdrawn (bought), a proportional amount of the other token must be deposited (sold) to keep the constant product maintained.
