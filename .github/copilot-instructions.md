...
```
docs/
├── swapx-integration/          # User guides & product docs
│   ├── welcome-to-swapx/       # Getting started, FAQs, about
│   ├── swap/                   # Trading guides & concepts
│   ├── liquidity-pool/         # LP guides for V2/V3
│   ├── bridging/               # Cross-chain with RainLink
│   ├── protocol/               # Tokenomics & protocol info
│   └── Pledge/                 # Staking documentation
└── swapx-developer/            # Technical documentation
    ├── contracts-v2/           # V2 smart contract docs
    ├── contracts-v3/           # V3 smart contract docs
    ├── sdks-core/              # Core SDK utilities
    ├── sdks-v2/                # V2 JavaScript SDK
    ├── sdks-v3/                # V3 JavaScript SDK
    ├── quick-start-tutorial/   # Step-by-step dev guide
    ├── troubleshooting/        # Common issues & solutions
    └── use-case-example/       # Implementation examples
```
...
pnpm build          # Production build → build/ directory
...
- **Frontmatter**: Required for all docs
  ...
  ---
  title: Display Title
  sidebar_label: "🔹 Short Label"  # Often includes emoji
  sidebar_position: 1
  ---
  ```
- **Emoji usage**: Heavily used in titles and labels (e.g., "👋 SwapX Product Overview", "🔄 Core Pillars")
